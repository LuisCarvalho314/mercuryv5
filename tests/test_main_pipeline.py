...
def _write_valid_run(tmp_path: Path, run_id: str, payload: dict) -> Path:
    ...
    layout.mercury_attribution_parquet.write_text("attr", encoding="utf-8")
    ...
    layout.mercury_bmu_attribution_step_png.write_text("plot", encoding="utf-8")
    layout.mercury_bmu_attribution_edge_f1_png.write_text("plot", encoding="utf-8")
    layout.mercury_bmu_attribution_node_ratio_png.write_text("plot", encoding="utf-8")
...
def test_collect_run_artifacts_includes_baseline_precision_artifacts(tmp_path: Path) -> None:
    ...
    assert artifacts["mercury_attribution_parquet"] == str(layout.mercury_attribution_parquet)
    ...
    assert artifacts["mercury_bmu_attribution_step_png"] == str(layout.mercury_bmu_attribution_step_png)
    assert artifacts["mercury_bmu_attribution_edge_f1_png"] == str(layout.mercury_bmu_attribution_edge_f1_png)
    assert artifacts["mercury_bmu_attribution_node_ratio_png"] == str(layout.mercury_bmu_attribution_node_ratio_png)
